...
def get_bold_and_sublist(lev1_task_contrast):
    ...
    lev1_out = (f'/oak/stanford/groups/russpold/data/uh2/aim1/BIDS/derivatives/output/'
...
def make_batch_file(outdir, model_lev2, lev1_task_contrast, batch_stub, num_subs):
    task, lev1_contrast, rtmodel =  lev1_task_contrast.split(':')
    filename_input_root = (f'{outdir}/{task}_lev1_contrast_{lev1_contrast}_rtmodel_{rtmodel}')
    if model_lev2=='one_sampt':
...
if __name__ == "__main__":
    ...
    batch_stub = '/oak/stanford/groups/russpold/data/uh2/aim1/analysis_code/run_stub.batch'
